<div>
    ...
    <header class="fixed-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-white-header px-md-5" id="header">
          <div class="container-fluid">
            <a class="navbar-brand" href="/">
              <svg class="site-logo d-block" xmlns="http://www.w3.org/2000/svg" width="110" height="22" viewBox="0 0 110 22" fill="none">
              ...
              {{-- <svg class="site-logo--inverse d-none" xmlns="http://www.w3.org/2000/svg" width="110" height="22" viewBox="0 0 110 22" fill="none">
                <g clip-path="url(#clip0_365_23075)">
            ...
            <div class="collapse navbar-collapse align-items-center justify-content-between" id="navbarSupportedContent">
                <div>
                    <ul class="navbar-nav">
                        <li class="nav-item">
                          <a class="nav-link account-subtitle fs-7" href="/all">Products</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link account-subtitle fs-7" href="/pages/our-story">About Db</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link account-subtitle fs-7" href="/pages/responsibility">Responsibility</a>
                        </li>
                    </ul>
                </div>
