    ...
    <div class="row d-flex align-items-center">
        <div class="col-md-5">
            <div class="form-group">
                ...
                <select name="product_attribute" id="selectAttribute" class="form-select" wire:model.live="attr">
        ...
        <div class="col-md-5">
            <div class="form-group">
                ...
                <select name="product_attribute_values" class="form-select" id="selectAttributeValue" wire:model="attr_value">
