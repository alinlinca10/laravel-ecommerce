          ...
          <div class="px-3">
              <div class="dropdown">
                  ...
                  @else
                    <ul class="dropdown-menu dropdown-menu-end rounded-0 py-0" style="width: 350px;">
                      <li class="p-4">
                        <p><strong>Ai cont?</strong></p>
                        <a class="btn btn-dark" href="/login">Conectează-te!</a>
                      </li>
                      <li class="bg-body-tertiary p-4">
                        <p><strong>Este prima ta vizită?</strong></p>
                        <p>Va dura puțin și vei beneficia de acces la numeroase funcționalități.</p>
                        <a class="btn btn-outline-dark" href="/register">Înregistrează-te!</a>
                      </li>
                    </ul>
                  @endif
              </div>
          ...
          <div>
            <a href="/checkout/cart" class="position-relative d-flex align-items-center text-decoration-none">
              <span class="position-relative">
                ...
                @endif
                <svg class="icon icon-bag d-none" width="16" height="22" viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
